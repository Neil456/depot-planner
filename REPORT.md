...
Generated by `scripts/make_report.py` on 2026-09-22 07:44 UTC. Every number below is read from a CSV under `results/` that was produced by running the code; nothing is hardcoded. Regenerate with `make battery && make report`.

## 1. Grid search: Dijkstra vs A* vs weighted A*

100 random start/goal pairs on one depot map (`configs/eval.yaml: grid_benchmark`), all three algorithms on every pair.

| algorithm | mean path cost | mean cost / optimal | worst cost / optimal | mean nodes expanded | max nodes expanded | mean ms | max ms |
| :-- | :-- | :-- | :-- | :-- | :-- | :-- | :-- |
| Dijkstra | 44.436 | 1.0000 | 1.0000 | 1479 | 2109 | 0.29 | 0.81 |
| A* | 44.436 | 1.0000 | 1.0000 | 348 | 1453 | 0.09 | 0.38 |
| Weighted A* (w=1.5) | 45.788 | 1.0297 | 1.1463 | 96 | 726 | 0.03 | 0.18 |
...
| :-- | :-- | :-- | :-- | :-- | :-- | :-- |
| Dijkstra | 100 | 8.7820 | 0.2931 | 30.0 | 0.00e+00 | yes |
| A* | 100 | 2.4762 | 0.0998 | 23.1 | 0.00e+00 | yes |
| Weighted A* (w=1.5) | 100 | 0.7707 | 0.0529 | 13.3 | 0.00e+00 | yes |
